      ...
      <div className="min-h-screen text-black p-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            <h2 className="text-gray-600 text-2xl mb-4">Our Services</h2>
            <h1 className="text-3xl md:text-4xl font-light leading-tight max-w-9xl mx-auto">
              ...
              >
                ...
                >
                  <div className="flex items-center gap-12">
                    ...
                    <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-light text-gray-700 group-hover:text-cyan-300 group-hover:scale-110 sm:group-hover:scale-110 lg:group-hover:scale-115 duration-300 ease-in-out transition-all">
                      {service.title}
                    </h3>
                  </div>
                  <div
